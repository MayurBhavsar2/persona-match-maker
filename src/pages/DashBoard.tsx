const Dashboard: React.FC = () => {
    ...
    const sampleArray = [{val:12, text:"Number of Personas"},{val:28, text:"Number of Candidates"},{val:7, text:"Number of Matches"}]
    return(
        <div className="w-screen flex justify-center items-start p-8 font-sans">
            <div className="grid md:grid-cols-3 grids-col-1 w-full place-items-center">
