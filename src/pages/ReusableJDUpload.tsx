...
import { Upload, FileText, Plus, ChevronRight, Type, File, X, Check, ChevronsUpDown,Loader2, Building2, MapPin, Globe, Save, Phone, Mail } from "lucide-react";
...
const ReusableJDUpload = () => {
  ...
  const fetchCompanies = async () => {
      ...
      try {
        ...
        const response = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/company/?${queryParams.toString()}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${localStorage.getItem("token")}`,
